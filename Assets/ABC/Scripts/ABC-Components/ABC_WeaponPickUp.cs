    ...
    public GameCreator.Runtime.VisualScripting.Actions gc2PickUpAction;
        ...
        private void UIHandler() {
            ...
            if (displayUI == true) {
                ...
                if (this.displayTextObject.Graphic.gameObject.name.Contains("*_ABC" + this.gameObject.GetEntityId().GetHashCode().ToString()) == false) {
                    this.displayTextObject.Graphic.gameObject.name = this.displayTextObjectStartName;
                    this.displayTextObject.Graphic.gameObject.name = "*_ABC" + this.gameObject.GetEntityId().GetHashCode().ToString() + this.displayTextObjectStartName;
                }
                ...
                if (this.displayTextObject.Graphic.gameObject.name.Contains("*_ABC" + this.gameObject.GetEntityId().GetHashCode().ToString())) {
