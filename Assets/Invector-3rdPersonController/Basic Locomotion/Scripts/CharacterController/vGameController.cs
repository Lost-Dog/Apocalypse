    ...
    public class vGameController : vMonoBehaviour
    {
        ...
        protected virtual IEnumerator RespawnRoutine()
        {
            ...
            if (playerPrefab != null && spawnPoint != null)
            {
                ...
                {
                    Debug.LogWarning("[vGameController] RespawnRoutine: instantiated playerPrefab has no vThirdPersonController — skipping listener registration. Respawn is handled by PlayerRespawnManager.");
                    yield break;
                }
