    ...
    public partial class vControlAI : vAIMotor, vIControlAI
    {
        ...
        public virtual bool isOnJumpLink
        {
            get
            {
                ...
                var linkData = navMeshAgent.currentOffMeshLinkData.owner;
                if (linkData != null)
                {
                    var offMeshLink = linkData as NavMeshLink;
                    if (offMeshLink != null && offMeshLink.area == UnityEngine.AI.NavMesh.GetAreaFromName("Jump"))
                    {
                        return true;
                    }
                }
