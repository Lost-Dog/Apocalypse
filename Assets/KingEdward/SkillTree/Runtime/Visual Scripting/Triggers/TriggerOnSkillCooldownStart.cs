...
{
    [Title("On Skill Cooldown Start")]
    [Category("KingEdward/Skill Tree/On Skill Cooldown Start")]
    [Description("Triggered when a skill cooldown starts")]
    
    [Image(typeof(IconSkill), ColorTheme.Type.Red)]
    
    [Keywords("Skill", "Tree", "Cooldown", "Start", "Event")]
    
    [Serializable]
    public class TriggerOnSkillCooldownStart : GameCreator.Runtime.VisualScripting.Event
    {
