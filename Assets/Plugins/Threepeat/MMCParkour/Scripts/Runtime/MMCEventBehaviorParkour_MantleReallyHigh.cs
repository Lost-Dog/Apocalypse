...
namespace Threepeat
{
    public class MMCEventBehaviorParkour_MantleReallyHigh : MMCEventBehaviorParkour_Mantle
    {
        public override bool CanPerformEvent()
        {
            return CanPerformMantleOrReallyHighMantle(true, true);
        }
        ...
        {
            return "parkour_mantle_reallyhigh";
        }
