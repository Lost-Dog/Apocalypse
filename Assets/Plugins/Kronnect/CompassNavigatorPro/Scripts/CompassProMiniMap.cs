...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        /// <summary>
        /// Source for the View Cone's field of view
        /// </summary>
        ...
        [Tooltip("The field of view for the cone when FoV source is user-defined.")]
        [SerializeField]
        [Range(0, 360)]
        ...
        public bool IsMouseOverMiniMap() {
            if (miniMapUIRootRT == null)
                return false;
            return RectTransformUtility.RectangleContainsScreenPoint(miniMapUIRootRT, GetPointerPosition());
        }
        ...
        public float GetAltitudeUnderMiniMapCamera() {
            ...
            if (!Physics.Raycast(ray, out RaycastHit hitInfo))
                return miniMapCamera.transform.position.y;
