...
namespace CompassNavigatorPro {
    ...
    public enum CompassBarOrientation {
        Camera,
        Follow
    }
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        [Tooltip("Compass group ID (1-4). POIs with matching group mask will register with this compass.")]
        [SerializeField, Range(1, 4)]
        int _compassGroup = 1;

        public int compassGroup {
            get { return _compassGroup; }
            set {
                if (value != _compassGroup) {
                    _compassGroup = Mathf.Clamp(value, 1, 4);
                    Refresh();
                }
            }
        }

        [Tooltip("Viewport rect in normalized coordinates (0-1). Use this to define the screen area for this compass instance. For split-screen: left half = (0,0,0.5,1), right half = (0.5,0,0.5,1).")]
        [SerializeField]
        Rect _viewportRect = new Rect(0, 0, 1, 1);
        ...
        [Tooltip("Only manage POIs that are within the area of interest")]
        [SerializeField]
        bool _enableAreaOfInterest;

        /// <summary>
        /// Only manage POIs that are within the area of interest
        /// </summary>
        public bool enableAreaOfInterest {
            get { return _enableAreaOfInterest; }
            set {
                if (value != _enableAreaOfInterest) {
                    _enableAreaOfInterest = value;
                }
            }
        }
        

        [Tooltip("Maximum distance to a POI to be considered as part of the area of interest")]
        [SerializeField]
        float _areaOfInterestMaxDistance = 50;

        public float areaOfInterestMaxDistance {
            get { return _areaOfInterestMaxDistance; }
            set {
                if (value != _areaOfInterestMaxDistance) {
                    _areaOfInterestMaxDistance = value;
                }
            }
        }


        [Tooltip("Updates POIs of interest list when player moves this distance")]
        [SerializeField]
        float _areaOfInterestUpdateDistance = 5;

        public float areaOfInterestUpdateDistance {
            get { return _areaOfInterestUpdateDistance; }
            set {
                if (value != _areaOfInterestUpdateDistance) {
                    _areaOfInterestUpdateDistance = value;
                }
            }
        }        
        ...
        [Tooltip("Which transform to use for orientation source")]
        [SerializeField]
        CompassBarOrientation _compassBarOrientation = CompassBarOrientation.Camera;

        public CompassBarOrientation compassBarOrientation {
            get { return _compassBarOrientation; }
            set {
                if (value != _compassBarOrientation) {
                    _compassBarOrientation = value;
                    needUpdateCompassBarIcons = true;
                }
            }
        }
        ...
        public float onScreenIndicatorAlpha {
            get { return _onScreenIndicatorAlpha; }
            set {
        ...
        [Tooltip("Speed for the scale animation of the indicators")]
        [SerializeField]
        float _onScreenIndicatorScaleSpeed = 10f;

        public float onScreenIndicatorScaleSpeed {
            get { return _onScreenIndicatorScaleSpeed; }
            set {
                if (value != _onScreenIndicatorScaleSpeed) {
                    _onScreenIndicatorScaleSpeed = value;
                }
            }
        }
        ...
        [SerializeField]
        float _onScreenIndicatorFarFadeDistance = 8000f;

        /// <summary>
        /// Distance at which the on-screen indicator will start to fade out before reaching max visible distance
        /// </summary>
        public float onScreenIndicatorFarFadeDistance {
            get { return _onScreenIndicatorFarFadeDistance; }
            set {
                if (value != _onScreenIndicatorFarFadeDistance) {
                    _onScreenIndicatorFarFadeDistance = value;
                }
            }
        }
        ...
        [Tooltip("Height of the distance text in the POI indicator")]
        [SerializeField]
        float _showDistanceHeight = 45f;

        /// <summary>
        /// Height of the distance text in the POI indicator
        /// </summary>
        public float showDistanceHeight {
            get { return _showDistanceHeight; }
            set {
                if (value != _showDistanceHeight) {
                    _showDistanceHeight = value;
                }
            }
        }        
        ...
        [Tooltip("Whether the distance in meters should be shown for off-screen indicators")]
        [SerializeField]
        bool _offScreenIndicatorShowDistance;

        /// <summary>
        /// Whether the distance in meters should be shown for off-screen indicators
        /// </summary>
        public bool offScreenIndicatorShowDistance {
            get { return _offScreenIndicatorShowDistance; }
            set {
                if (value != _offScreenIndicatorShowDistance) {
                    _offScreenIndicatorShowDistance = value;
                }
            }
        }

        [Tooltip("The string format for displaying the distance for off-screen indicators. The syntax for this string format corresponds with the available options for ToString(format) method of C#")]
        [SerializeField]
        string _offScreenIndicatorShowDistanceFormat = "0m";

        /// <summary>
        /// The string format for displaying the distance for off-screen indicators.
        /// This string format corresponds with the available options for ToString(format) method of C#.    
        /// </summary>
        public string offScreenIndicatorShowDistanceFormat {
            get { return _offScreenIndicatorShowDistanceFormat; }
            set {
                if (value != _offScreenIndicatorShowDistanceFormat) {
                    _offScreenIndicatorShowDistanceFormat = value;
                }
            }
        }
        ...
        /// POI will only register with compasses whose group matches the POI's group mask.
        /// </summary>
        public bool POIRegister (CompassProPOI newPOI) {
            ...
            for (int i = 0; i < compassCount; i++) {
                ...
                if (compass != null && newPOI.MatchesCompassGroup(compass._compassGroup)) {
                    compass.Refresh();
        ...
        public void POIUnregister (CompassProPOI newPOI) {
            ...
            for (int i = 0; i < compassCount; i++) {
                ...
                if (compass != null && newPOI.MatchesCompassGroup(compass._compassGroup)) {
                    compass.Refresh();
                    compass.POIUnregister_internal(newPOI);
                }
            }
        }
        ...
        public void POIFocus (CompassProPOI poi) {
            ...
            for (int i = 0; i < compassCount; i++) {
                CompassPro compass = compasses[i];
                if (compass != null && poi.MatchesCompassGroup(compass._compassGroup)) {
        ...
        /// </summary>
        public GameObject POIShowBeacon (CompassProPOI existingPOI, float duration, float horizontalScale = 1f, bool playSound = true) {
            return POIShowBeacon(existingPOI, duration, horizontalScale, 1f, Color.white, playSound);
        }
        ...
        /// Show a light beacon over the specified POI.
        /// </summary>
        public GameObject POIShowBeacon (CompassProPOI existingPOI, float duration, float horizontalScale, float intensity, Color tintColor, bool playSound = true) {
            ...
            beacon.localScale = new Vector3(beacon.localScale.x * horizontalScale, beacon.localScale.y, beacon.localScale.z * horizontalScale);
            ...
            anim.target = existingPOI.transform;
        ...
        /// Show a light beacon over the specified POI.
        /// </summary>
        public GameObject POIShowBeacon (Vector3 position, float duration, float horizontalScale = 1f, bool playSound = true) {
            return POIShowBeacon(position, duration, horizontalScale, 1f, Color.white, playSound);
        }

        /// <summary>
        /// Show a light beacon over the specified POI.
        /// </summary>
        public GameObject POIShowBeacon (Vector3 position, float duration, float horizontalScale, float intensity, Color tintColor, bool playSound = true) {
        ...
        /// </summary>
        public void POIShowBeacon (float duration, float horizontalScale = 1f, bool playSound = true) {
            POIShowBeacon(duration, horizontalScale, 1f, Color.white, playSound);
        }

        /// <summary>
        /// Show a light beacon over all non-visited POIs for duration in seconds and with optional custom horizontal scale for the bright cylinder.
        /// </summary>
        public void POIShowBeacon (float duration, float horizontalScale, float intensity, Color tintColor, bool playSound = true) {
            int poiCount = pois.Count;
            for (int k = 0; k < poiCount; k++) {
                CompassProPOI poi = pois[k];
                if (poi == null || poi.isVisited || (!poi.isVisible && showCompassBar))
                    continue;
                POIShowBeacon(poi, duration, horizontalScale, intensity, tintColor, playSound);
            }
        }
        ...
        public float degrees {
            get {
                ...
                if (_compassBarOrientation == CompassBarOrientation.Follow && _follow != null) {
                    angles = _follow.eulerAngles.y;
                } else {
                    angles = _cameraMain.transform.eulerAngles.y;
                }
        ...
        public void POIGetVisited (List<CompassProPOI> pois) {
            pois.Clear();
            int poiCount = this.pois.Count;
            for (int i = 0; i < poiCount; i++) {
                CompassProPOI poi = this.pois[i];
        ...
        /// <summary>
        /// Returns a list of unvisited POIs
        /// </summary>
        /// <param name="pois"></param>
        ...
        /// <summary>
        /// Manually sets a POI's visited status and triggers appropriate actions if setting to visited
        /// </summary>
        /// <param name="poi">The POI to modify</param>
        /// <param name="visited">True to mark as visited (triggers events/audio/text), false to mark as unvisited</param>
        public void POISetVisited (CompassProPOI poi, bool visited) {
            if (poi == null) return;

            if (visited && !poi.isVisited) {
                // Setting to visited - replicate automatic visiting behavior
                poi.isVisited = true;

                // Hide POI if configured
            ...
            } else if (!visited && poi.isVisited) {
                // Setting to unvisited - just change the flag
                poi.isVisited = false;

                // Re-enable POI if it was hidden
                if (poi.hideWhenVisited) {
                    poi.enabled = true;
                }
            }
