...
namespace ThreepeatEditor
{
    ...
    public class MMCFinalIKGrounderIntegration : MMCLegacyIntegrationBase
    {
        ...
        //private int grounderIgnoreLayer = 11;
        ...
        public override void MakeGUI()
        {
            ...
            showHelp_GrounderLayers = ThreepeatEditorGUIUtilities.LabelWithHelp.LabelWithHelpField(
                    ...
                    "1. Create a GrounderIgnore layer to be used for the actual smooth slope objects for the character collider to use.  This allows character controllers to move smoothly up and down inclines without \n" +
            ...
            LayerMask tempMask = EditorGUILayout.MaskField(new GUIContent("Grounder Ground Layers", "Which layers should be treated as ground by Grounder.  This should be GrounderOnly and Character's ground layers without GrounderIgnore"), InternalEditorUtility.LayerMaskToConcatenatedLayersMask(grounderGroundLayers), InternalEditorUtility.layers);
        ...
        private void DrawHelpBox_PhysicsCollisionLayers()
        {
            if (layerCollisionTex == null)
            {
                ...
                //Debug.Log("texture load successful");
            }
        ...
        public override bool SetupCharacter(GameObject coreObject, GameObject modelObject)
        {
            ...
            //TODO: add checks for FindComponentInChildren to see if FBBIK and GFBBIK are already there
            ...
            /*Biped references were auto-detected on a FullBodyBipedIK component that was added in runtime.
             * Note that this only happens in the Editor and if the GameObject is selected
             * (for quick and convenient debugging).If you want to add FullBodyBipedIK dynamically in runtime via script, 
             * you will have to use BipedReferences.AutodetectReferences() for automatic biped detection.*/
...
namespace ThreepeatEditor
{
    ...
    public class MMCFinalIKGrounderIntegration : MMCLegacyIntegrationBase
    {
        ...
        public override void MakeGUI()
        {
            EditorGUILayout.HelpBox("FinalIK is not installed. Install FinalIK and add ROOTMOTION_FINALIK define to enable this integration.", MessageType.Info);
            doSetupFinalIK = false;
            doSetupGrounder = false;
        }
