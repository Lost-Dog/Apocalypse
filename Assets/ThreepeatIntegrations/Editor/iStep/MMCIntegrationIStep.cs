...
namespace ThreepeatEditor
{
    public class MMCIntegrationIStep : MMCIntegrationBase
    {
        public override string GetDescription() => "Integrates iStep foot placement system with MMLC";
        public override string GetIntegrationName() => "iStep (foot placement system)";
        public override bool IsMajorIntegration() => true;
        public override void MakeGUI() { }
        public override void OnIntegrationEnable() { }
        public override bool SetupIntegration(GameObject rootObject, GameObject modelObject, NGCharacter character, GameObject camObject = null) => true;
    }
}
#endif
